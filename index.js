/**
 * @file  dable-button/index.js
 * @brief button component for dable
 * @license MIT
 */
const Text   = require("dable-text");
const Click  = require("dable-event-click");
const SynHei = require("dable-effect-synchei");
const Border = require("dable-effect-border");
const cmputl = dable.util.component;
...
module.exports = class extends dable.class.Component {
     ...
     *                dable-text: button text component
     * @param (mixed) text component config
     * @return (dable-text) button text
     * @type parameter
     */
    text (txt, cnf) {
        try {
